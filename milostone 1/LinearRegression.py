...
df1Corr.style.background_gradient(cmap=sns.light_palette("red", as_cmap=True)) #000000000
...
test_new=test.drop(['ID','Dew point temperatur
                    e(°C)','Date','Year'],axis=1)
...
results_df.to_csv('Linear.csv',index=False)